...
/*the below const variables represent the button elements on the web page. */
...
class Calculator {
    ...
    constructor(previousDisplayElementWeb, currentDisplayElementWeb) {      /*pass in web display elements to this object.*/
       this.previousOperandTextElement = previousDisplayElementWeb;         /*object property refers to web element's address.  */
       this.currentOperandTextElement = currentDisplayElementWeb;           /*This property is web element itself. used in display() function below.*/
    ...
    compute() {
		let result;
        const prev = parseFloat(this.previousOperand);     /*convert string to float number for computing.*/
        ...
        this.operation = undefined;    /*after computing, the oeration symbol is cleared out.*/
...
/*The Array.forEach() method calls a function for each element in an array. 
  button is the current value in numberbuttons array:(nodelist:number button elements on the web).
  numberButtons variable is the element list on web page. */  
...
/*The Array.forEach() method calls a function for each element in an array. 
  button is the current value in operationButtons array:(nodelist:operator button elements on the web).*/
