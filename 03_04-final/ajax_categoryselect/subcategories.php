...
$categories = [
  ...
  $category_id = isset($_GET['category_id']) ? (int) $_GET['category_id'] : 0;    //GET data from client to server's php file

  foreach($categories as $category) {         //foreach($array as $eachValue)
